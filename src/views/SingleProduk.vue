            ...
            <div v-if="produk">
                ...
                <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                        ...
                        <div class="lg:flex lg:items-start">
                            <div class="lg:order-2 lg:ml-5">
                                <div class="max-w-xl overflow-hidden rounded-lg">
                                    <img class="h-full w-full max-w-full object-cover" :src="produk.image" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                                <div class="flex flex-row items-start lg:flex-col">
                                    <button type="button"
                                        ...
                                        <img class="h-full w-full object-cover" :src="produk.image" alt="" />
                                    </button>
                                    <button type="button"
                    ...
                    <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                        <h1 class="sm: text-2xl font-bold text-gray-900 sm:text-3xl">{{ produk.title }}</h1>
                        ...
                        <div class="mt-5 flex items-center">
                            ...
                            <p class="ml-2 text-sm font-medium text-gray-500">{{ produk.rating.rate }}</p>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-end">
                                <h1 class="text-3xl font-bold">${{ produk.price }}</h1>
...
export default {
    computed: {
        ...
        produk() {
            const produkId = parseInt(this.$route.params.id);
            return this.getProdukById(produkId);
        },
    },
};
</script>